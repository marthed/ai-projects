...
var _overview = __webpack_require__(27);
...
var Overview = function (_React$Component) {
  ...
  function Overview() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Overview.__proto__ || Object.getPrototypeOf(Overview)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function () {
      console.log('clicked!');
  ...
  _createClass(Overview, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'overview' },
        _react2.default.createElement('button', { type: 'button', onClick: this.onClick })
      );
    }
  }]);
